 <div class="container">
	<div class="row mb-5">
		...
		<div class="col-md-3">
			<h5>Ekspedisi</h5>
			<p><?php echo $transaksi['nama_ekspedisi'] ?>, <?php echo $transaksi['layanan_ekspedisi'] ?>, <?php echo $transaksi['estimasi_ekspedisi'] ?>, <?php echo $transaksi['berat_ekspedisi'] ?> Gr</p>
		</div>
	</div>
