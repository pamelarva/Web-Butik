...
class Transaksi extends CI_Controller {
    ...
    public function index()
    {
        ...
        //paggil model Mtransaksi dan fungsi transaksi_member_beli
    ...
    function detail($id_transaksi) {
        ...
        if ($data['transaksi']['status_transaksi']=="pesan") {
            ...
            \Midtrans\Config::$serverKey = 'SB-Mid-server-4jyuqF_7OfscAkNE3xIyUxBA';
            ...
            curl_setopt_array($curl, array(
              ...
              CURLOPT_HTTPHEADER => array(
                "accept: application/json","authorization: Basic U0ItTWlkLXNlcnZlci00anl1cUZfN09mc2NBa05FM3hJeVV4QkE6YW1pa29t"
              ),
            ));
