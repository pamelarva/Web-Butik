...
<?php if (!empty($snapToken)): ?>
    ...
    <script src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-1jZ04qowRM31_WiO"></script>
    ...
    <div class="container">
        ...
        <?php foreach ($transaksi_detail as $k => $v): ?>
            ...
            <?php if (!empty($v['jumlah_rating'])): ?>
                ...
                <?php endforeach ?>
                <div class="bg-light small text-muted"><?php echo $v['ulasan_rating'] ?></div>
                <hr>
            <?php endif ?>
        <?php endforeach ?>
